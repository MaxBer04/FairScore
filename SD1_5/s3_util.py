...
def main():
    ...
    parser.add_argument('--compressed_file', default='gender-100occs-10k', help='Name of the compressed file')
    ...
    parser.add_argument('--storage_type', choices=['s3', 'r2'], default='s3', help='Choose between S3 and Cloudflare R2')
