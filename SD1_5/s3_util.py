...
def main():
    ...
    parser.add_argument('--dataset_dir', default='wandb', help='Directory containing the dataset')
    parser.add_argument('--compressed_file', default='wandb', help='Name of the compressed file')
