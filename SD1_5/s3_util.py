...
def main():
    ...
    parser.add_argument('--dataset_dir', default='dataset_2_ms', help='Directory containing the dataset')
    parser.add_argument('--compressed_file', default='ms_dataset', help='Name of the compressed file')
