...
def main():
    ...
    parser.add_argument('--dataset_dir', default='d_RV2_5000_balanced_analysis---06T-5it', help='Directory containing the dataset')
    parser.add_argument('--compressed_file', default='d_RV2_5000_balanced---06T-5it', help='Name of the compressed file')
